...
final class RulerView extends View {
    ...
    private Paint mShortIndicatorPaint;
     ...
     */
    private float mLongIndicatorHeightRatio = 0.4f /* Default value */;
     ...
     */
    private float mShortIndicatorHeightRatio = 0.2f /* Default value */;
    ...
    private void refreshPaint() {
        ...
        mLongIndicatorPaint.setColor(mIndicatorColor);
        mLongIndicatorPaint.setStrokeWidth(mIndicatorWidthPx);
        mLongIndicatorPaint.setStyle(Paint.Style.STROKE);
        
        mShortIndicatorPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mShortIndicatorPaint.setColor(mIndicatorColor);
        mShortIndicatorPaint.setStrokeWidth(mIndicatorWidthPx / 2);
        mShortIndicatorPaint.setStyle(Paint.Style.STROKE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int value = mMinValue; value <= mMaxValue; value++) {
            ...
            if (value % 5 == 0) {
                drawLongIndicator(canvas, value - mMinValue);
                drawValueText(canvas, value - mMinValue);
            } else {
                drawSmallIndicator(canvas, value- mMinValue);
            }
        }
    ...
    private void drawValueText(@NonNull final Canvas canvas,
        ...
        canvas.drawText(String.valueOf(value + mMinValue),
                mIndicatorInterval * value,
                mLongIndicatorHeight + mTextPaint.getTextSize() * 1.5f,
                mTextPaint);
    }
    ...
    void setTextSize(final int textSizeSp) {
        mTextSize = PixeUtils.sp2px(textSizeSp);
        refreshPaint();
    }
