...
public class LogUtils {
	/** 日志输出时的TAG */
	private static String mTag = "xxLog2";
	/** 日志输出级别NONE */
	public static final int LEVEL_OFF = 0;  //当LEVEL_OFF为0时， 关闭所有日志输出l
	/** 日志输出级别NONE */
	public static final int LEVEL_ALL = 7;	//开启日志输出，    信息在Constans里面配置
